...
from kernels.wl_kernels import periodicBC, RandomWalkSphere, kernel_currents_plus_winds
...
def main():
    ...
    currents_field_set.add_field(winds_field_set.U,'U_wind')
    currents_field_set.add_field(winds_field_set.V,'V_wind')
    ...
    pset = ParticleSet(fieldset=currents_field_set, pclass=JITParticle, lon=lon0, lat=lat0,
    ...
    pset.execute(pset.Kernel(kernel_currents_plus_winds),
