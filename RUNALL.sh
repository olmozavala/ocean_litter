...
#mpirun -np 8 python 1_WorldLitter.py 2010-01-01:0 2015-01-01:0 False True False NoWinds_YesDiff_2010_01 True 30 > Running.log &
#mpirun -np 8 python 1_WorldLitter.py 2010-12-27:0 2015-01-01:0 False True False NoWinds_YesDiff_2010_01 /data/UN_Litter_data/output/NoWinds_YesDiff_2010_01_2010-11-27_2010-12-27.nc 30 > Running.log &

# start_date=2010-01-01:0  end_date=2010-01-04:0 unbeaching=True name=DELETE
#mpirun -np 8 python 2_MergeRuns.py 2010-01-01:0 2015-01-01:0 False NoWinds_YesDiff_2010_01 30 > Merging.log &
