...
output_path="~/scratch/Output_2022"
...
do
  ...
  then
    ...
    cmd="mpirun -np ${proc} python WorldLitter.py ${c_start_date}:0 ${c_end_date}:0 True True False $run_name ~/scratch/Output_Final/TenYears_YesWinds_YesDiffusion_NoUnbeaching_20YEAR_MONTH.nc $inc_per_run"
  else
